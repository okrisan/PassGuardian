...
grigi metallici. Nessun altro modulo dovrebbe definire colori "hardcoded":
tutto passa da qui, cosi' il tema resta coerente in tutta l'app.
"""
...
# --- Fondali (dal nero assoluto al viola profondo) ---
VOID        = "#050308"   # nero quasi assoluto (sfondo finestra)
...
# --- Viola / Magenta neon (accento principale del brand) ---
PURPLE_DEEP    = "#3a1a5c"
...
# --- Stati semantici (mantenuti dentro la stessa temperatura cromatica) ---
SUCCESS      = "#39e991"
SUCCESS_DIM  = "#1f6e4f"
DANGER       = "#ff4d6a"
DANGER_DIM   = "#7a2333"
...
def apply_global_theme():
    ...
    ctk.set_default_color_theme("dark-blue")  # base, verra' sovrascritta dai widget


def style_treeview(style, row_height=32):
    """Applica il tema cyberpunk a un ttk.Treeview (usato per le tabelle vault/utenti)."""
...
# Stile riutilizzabile per bottoni "primari" (viola neon)
...
# Stile per bottoni "secondari" (contorno viola, sfondo scuro)
...
# Stile per bottoni "pericolo" (rosso/magenta)
...
# Stile per bottoni "ghost" della sidebar (nessuno sfondo finche' non attivo/hover)
